...
--
-- Хост: 127.0.0.1
-- Время создания: Фев 21 2023 г., 21:59
...
(34, '4', '2023-02-17 00:22:00', '2023-02-25 00:22:00', '123123.00'),
(35, '4', NULL, NULL, NULL),
(91, '6B', '2023-02-02 02:48:00', '2023-02-24 02:49:00', '123123.00'),
(92, '6A', NULL, NULL, NULL),
(93, '6A', '2023-02-02 02:54:00', '2023-02-24 02:54:00', '123123.00'),
(94, '6A', NULL, NULL, NULL),
(95, '6A', '2023-02-02 02:54:00', '2023-02-24 02:54:00', '123123.00'),
(96, '6B', NULL, NULL, NULL),
(97, '6B', NULL, NULL, NULL),
(98, '6B', '2023-02-02 03:14:00', '2023-03-02 03:14:00', '123123.00'),
(99, '6B', NULL, NULL, NULL),
(100, '6B', '2023-02-02 03:14:00', '2023-03-02 03:14:00', '123123.00'),
(101, '6B', NULL, NULL, NULL),
(102, '6B', '2023-02-02 03:14:00', '2023-03-02 03:14:00', '123123.00'),
(103, '6B', NULL, NULL, NULL),
(104, '6B', '2023-02-02 03:14:00', '2023-03-02 03:14:00', '123123.00'),
(105, '6A', NULL, NULL, NULL),
(106, '6A', NULL, NULL, NULL),
(107, '6A', '2023-02-23 03:50:00', '2023-02-24 03:50:00', '12313.00');
...
--
ALTER TABLE `residents_in_accomodation`
  ADD CONSTRAINT `residents_in_accomodation_ibfk_1` FOREIGN KEY (`id_accomodation`) REFERENCES `accommodation` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `residents_in_accomodation_ibfk_2` FOREIGN KEY (`id_resident`) REFERENCES `resident` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
